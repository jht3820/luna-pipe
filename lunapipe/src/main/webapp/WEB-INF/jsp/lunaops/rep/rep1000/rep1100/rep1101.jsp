...
<script>
	...
	$(document).ready(function() {
		...
		/* 닫기버튼 클릭 시 팝업 창 사라지기*/
		$('#btn_cancle_rep1101').click(function() {
			gfnLayerPopupClose();
		});
	});
	...
	function fnGetFileContent(){
		...
		var ajaxObj = new gfnAjaxRequestAction(
			{"url":"<c:url value='/rep/rep1000/rep1100/selectRep1101FileDiffContentAjax.do'/>","loadingShow":false},
			{
		...
		ajaxObj.setFnSuccess(function(data){
			...
			if(data.errorYn =="N"){
				...
				if(repTypeCd != '03'){
					//리비전 정보 넣기
					$("span#rep1101Revision").text(data.revision);
	...
	<div class="popup">
		...
		<div class="btn_div fileMainBtnFrame">
			<div class="button_normal exit_btn" id="btn_cancle_rep1101">닫기</div>
		</div>
	</div>
</html>
...
// 한자리 숫자에 0을 추가하는 유틸리티 function
Date.LZ = function(x) {return(x<0||x>9?"":"0")+x};
// Full month names. 한글 표기이므로 1월, 2월 등으로 표시
Date.monthNames = new Array('1월','2월','3월','4월','5월','6월','7월','8월','9월','10월','11월','12월');
// Month abbreviations. 영문일 경우 December → Dec 축약을 하나 한글일 경우 축약이 필요없으므로 1월, 2월, 3월 등으로 표시
Date.monthAbbreviations = new Array('1월','2월','3월','4월','5월','6월','7월','8월','9월','10월','11월','12월');
// 요일명
Date.dayNames = new Array('일요일','월요일','화요일','수요일','목요일','금요일','토요일');
// 요일명 축약
Date.dayAbbreviations = new Array('일','월','화','수','목','금','토');
/*
 * 1/2/2000 과 같이 모호한 날짜를 파싱하는데 사용, 기본적으로 1/2/2000 이 1월 2일을 의미하는 미국식으로 표시
 * 1/2/2000 이 2월 1일을 의미하는 유럽식으로 표시하려면 false로 설정
 */
Date.preferAmericanFormat = true;

// 0일 일요일부터 시작하는 미국식, 1일 경우 월요일부터 시작하는 유럽식
...
Date.prototype.isHolidayCss=function(){
	  return isHolidayCss(this);
};

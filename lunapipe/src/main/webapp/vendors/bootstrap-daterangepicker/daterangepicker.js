...
(function (root, factory) {
    ...
    var DateRangePicker = function(element, options, cb) {
        ...
        this.ranges = {};
        this.addButton = true;
        this.addButtonImg = "/images/calendar.png";
        ...
        if (typeof options.addButton === 'boolean')
            this.addButton = options.addButton;
        
        if (typeof options.addButtonImg === 'string')
            this.addButtonImg = options.addButtonImg;
    ...
    $.fn.daterangepicker = function(options, callback) {
        ...
        this.each(function() {
            ...
            //image button check
            var addButton = el.data("daterangepicker").addButton;
            var addButtonImg = el.data("daterangepicker").addButtonImg;
            
            
            //button image 추가
            if(!$(this).next().hasClass("ui-datepicker-trigger") && addButton){
            	$(this).parent().append('<img class="ui-datepicker-trigger" src="'+addButtonImg+'" alt="..." title="...">');
            	$(this).width($(this).width()-($(".ui-datepicker-trigger").width()+12));
            	//click event 걸기

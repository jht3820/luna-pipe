...
;(function ($, window, document, undefined) {
    ...
    $.extend(SmartWizard.prototype, {
        ...
        _setToolbar: function () {
            ...
            var btnNext = this.options.toolbarSettings.showNextButton !== false ? $('<button></button>').html(this.options.lang.next).addClass('btn btn-secondary sw-btn-next').attr('type', 'button').attr('guide','nextButton') : null;
            var btnPrevious = this.options.toolbarSettings.showPreviousButton !== false ? $('<button></button>').html(this.options.lang.previous).addClass('btn btn-secondary sw-btn-prev').attr('type', 'button').attr('guide','prevButton') : null;

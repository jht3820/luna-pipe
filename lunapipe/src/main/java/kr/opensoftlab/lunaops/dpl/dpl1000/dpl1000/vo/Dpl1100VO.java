...
public class Dpl1100VO extends PageVO{
	...
	public String getJobStartOrd() {
		return jobStartOrd;
	}
	public void setJobStartOrd(String jobStartOrd) {
	...
	public String getJobRestoreDesc() {
		return jobRestoreDesc;
	}
